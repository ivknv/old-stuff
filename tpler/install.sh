...
#if [[ ! -e $installation_path/$script_name ]]; then
#	echo "ln -s $installation_path/tpler.py $installation_path/$script_name"
#	ln -s $installation_path/tpler.py $installation_path/$script_name
#fi
